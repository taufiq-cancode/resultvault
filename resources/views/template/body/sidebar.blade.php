<nav class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start position-absolute ms-3 bg-grey loopple-fixed-start" id="sidenav-main" style="height: 100vh;">
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <!-- Check if authenticated user role is admin or teacher-->
            ...
            <li class="nav-item">
                <a class="nav-link  " href="javascript:;">
                    ...
                    <span class="nav-link-text ms-1">Auto promote</span>
                </a>
            </li>
            @endif  
            <!-- End Check -->              
